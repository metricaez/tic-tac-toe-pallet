...
fn join_a_game_works() {
	new_test_ext().execute_with(|| {
		...
		assert_eq!(Tictactoe::game_index(), 1);
		assert_eq!(crate::Games::<Test>::get(0).unwrap().bet, Some(bet));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().jackpot, Some(bet * 2));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().payout_addresses, (creator, joiner));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().ended, false);
...
fn end_game_works() {
	new_test_ext().execute_with(|| {
		...
		assert_eq!(crate::Games::<Test>::get(0).unwrap().payout_addresses, (creator, creator));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().ended, false);
		assert_eq!(Balances::free_balance(Tictactoe::account_id()), bet + pallet_funding);
		...
		assert_eq!(crate::Games::<Test>::get(0).unwrap().payout_addresses, (creator, joiner));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().ended, false);
		assert_eq!(Balances::free_balance(Tictactoe::account_id()), (bet * 2) + pallet_funding);
		...
		assert_eq!(Tictactoe::game_index(), 1);
		assert_eq!(crate::Games::<Test>::get(0).unwrap().bet, Some(bet));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().jackpot, Some(0));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().payout_addresses, (creator, joiner));
		assert_eq!(crate::Games::<Test>::get(0).unwrap().ended, true);
